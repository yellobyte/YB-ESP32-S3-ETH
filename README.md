...
Since the board has both Wifi and Ethernet connectivity **it can even bridge the two interfaces at Layer 2 or via NAT**, allowing devices connected to a Wifi Soft-AP to communicate with devices on the Ethernet network and even the internet if the Ethernet is connected to an internet router. Please see examples [WiFi-Ethernet-Layer2-Bridge](https://github.com/yellobyte/YB-ESP32-S3-ETH/tree/main/examples/ArduinoIDE/WiFi-Ethernet-Layer2-Bridge) and [WiFi-Ethernet-NAT-Bridge](https://github.com/yellobyte/YB-ESP32-S3-ETH/tree/main/examples/ArduinoIDE/WiFi-Ethernet-NAT-Bridge).
